...
public class PatientgetHistory extends AppCompatActivity {
    Button b1;
    EditText ed;
    Intent intent;
    String TAG = "debugg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patientget_history);
        b1 = (Button) findViewById(R.id.button2);
        ed = (EditText) findViewById(R.id.ed1);
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String url = "http://10.4.5.139:8080/HospitalManagementServer/PatientHistory";
    ...
    private void parseResult(String result) {
        ...
        PatHistoryDto in = new Gson().fromJson(result, PatHistoryDto.class);

        new StaticObjects().setPatHistoryDto(in);
    ...
    class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                ...
                intent = new Intent(getApplicationContext(), PatientHistory.class);
